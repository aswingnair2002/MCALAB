public class Stringz {
	     public static void main(String []args){
	        String text = "Okay Okay perfect Okay";
			...
			System.out.println("\nReplace first word: "+text.replaceFirst("Okay","Java"));
		    ...
		    System.out.println("\nText for Comparison:okay okay perfect okay->"+ text.compareTo("okay okay perfect okay"));
		    System.out.println("Text for Comparison:Okay Okay perfect Okay->"+ text.compareTo("Okay Okay perfect Okay"));
	     }
	}
